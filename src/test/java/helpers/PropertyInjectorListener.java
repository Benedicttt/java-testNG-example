...
public class PropertyInjectorListener implements IExecutionListener, IAlterSuiteListener, IAnnotationTransformer, IInvokedMethodListener, ITestListener, IReporter {
    @Override
